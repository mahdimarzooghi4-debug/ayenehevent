      ...
      <div className="mx-auto w-full max-w-[1800px] px-6 py-10 lg:px-[110px]">
        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-2 xl:grid-cols-[1.3fr_0.9fr_0.9fr_1fr_1.35fr] xl:gap-14">
          <div className="flex flex-col items-start xl:order-1">
            ...
            <p className="mt-3 w-full max-w-[420px] text-center text-[17px] font-medium text-[#E0C89F]">
          ...
          <div className="xl:order-5">
            ...
            <div className="flex flex-wrap gap-3">
              <div className="flex h-[155px] w-[210px] items-center justify-center rounded-[16px] border border-[#E0C89F] bg-[#FAF9F7] p-4">
                <img src="./images/committee-logo.webp" alt="کمیته امداد امام خمینی" className="max-h-[125px] max-w-full object-contain" />
              </div>
              <div className="flex h-[155px] w-[210px] items-center justify-center rounded-[16px] border border-[#E0C89F] bg-[#FAF9F7] p-4">
                <img src="./images/creative-house-logo.webp" alt="خانه خلاق و نوآوری آینه" className="max-h-[120px] max-w-full object-contain" />
              </div>
            </div>
          </div>
        </div>
